...
class LocationsApi(object):
    ...
    def get_clan_builder_base_ranking(self, location_id, **kwargs):  # noqa: E501
        """Get clan Builder Base rankings for a specific location  # noqa: E501

        Get clan Builder Base rankings for a specific location  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_clan_builder_base_ranking(location_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_clan_builder_base_ranking_with_http_info(location_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_clan_builder_base_ranking_with_http_info(location_id, **kwargs)  # noqa: E501
            return data

    def get_clan_builder_base_ranking_with_http_info(self, location_id, **kwargs):  # noqa: E501
        """Get clan Builder Base rankings for a specific location  # noqa: E501

        Get clan Builder Base rankings for a specific location  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_clan_builder_base_ranking_with_http_info(location_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_clan_builder_base_ranking" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('location_id' not in params or
            ...
            raise ValueError("Missing the required parameter `location_id` when calling `get_clan_builder_base_ranking`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/locations/{locationId}/rankings/clans-builder-base', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ClanBuilderBaseRankingList',  # noqa: E501
    ...
    def get_clan_capital_ranking(self, location_id, **kwargs):  # noqa: E501
        """Get capital rankings for a specific location  # noqa: E501

        Get capital rankings for a specific location  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_clan_capital_ranking(location_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_clan_capital_ranking_with_http_info(location_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_clan_capital_ranking_with_http_info(location_id, **kwargs)  # noqa: E501
            return data

    def get_clan_capital_ranking_with_http_info(self, location_id, **kwargs):  # noqa: E501
        """Get capital rankings for a specific location  # noqa: E501

        Get capital rankings for a specific location  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_clan_capital_ranking_with_http_info(location_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_clan_capital_ranking" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params or
                params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `get_clan_capital_ranking`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/locations/{locationId}/rankings/capitals', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ClanCapitalRankingList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_player_builder_base_ranking(self, location_id, **kwargs):  # noqa: E501
        """Get player Builder Base rankings for a specific location  # noqa: E501

        Get player Builder Base rankings for a specific location  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_player_builder_base_ranking(location_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_player_builder_base_ranking_with_http_info(location_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_player_builder_base_ranking_with_http_info(location_id, **kwargs)  # noqa: E501
            return data

    def get_player_builder_base_ranking_with_http_info(self, location_id, **kwargs):  # noqa: E501
        """Get player Builder Base rankings for a specific location  # noqa: E501

        Get player Builder Base rankings for a specific location  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_player_builder_base_ranking_with_http_info(location_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_player_builder_base_ranking" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params or
                params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `get_player_builder_base_ranking`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/locations/{locationId}/rankings/players-builder-base', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PlayerBuilderBaseRankingList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
