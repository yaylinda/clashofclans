...
class Player(object):
    ...
    def __init__(self, achievements=None, attack_wins=None, best_builder_base_trophies=None, best_trophies=None, builder_base_league=None, builder_base_trophies=None, builder_hall_level=None, clan=None, clan_capital_contributions=None, defense_wins=None, donations=None, donations_received=None, exp_level=None, hero_equipment=None, heroes=None, labels=None, league=None, legend_statistics=None, name=None, player_house=None, role=None, spells=None, tag=None, town_hall_level=None, town_hall_weapon_level=None, troops=None, trophies=None, war_preference=None, war_stars=None):  # noqa: E501
